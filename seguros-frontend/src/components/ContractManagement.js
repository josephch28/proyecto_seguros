                    ...
                    <Grid container spacing={2}>
                      ...
                      <Grid item xs={12} md={6}>
                        <TextField
                          ...
                          onChange={(e) => handleBeneficiaryChange(index, 'apellido', e.target.value)}
                        />
                      </Grid>
                      <Grid item xs={12} md={6}>
                        <TextField
                      ...
                      <Grid item xs={12}>
                        <Button
                          ...
                          startIcon={<UploadIcon />}
                        >
                          Subir Documentos del Beneficiario
                          <input
                            type="file"
                            hidden
                            accept=".pdf"
                            onChange={(e) => handleBeneficiaryDocumentsChange(index, e)}
                          />
                        </Button>
                        {beneficiaryDocuments[index] && (
                          <Typography variant="body2" color="textSecondary" sx={{ mt: 1 }}>
                            Archivo seleccionado: {beneficiaryDocuments[index].name}
                          </Typography>
                        )}
                        {selectedContract?.documentos_beneficiarios?.[index] && (
